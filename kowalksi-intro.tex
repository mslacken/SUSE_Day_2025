...
\begin{frame}{Model Context Protocol (MCP) - the other kid in town}
    \begin{block}{open standard for AI-tool integration, introduced by Anthropic (Nov 2024):}
    \begin{itemize}
    ...
    \begin{columns}
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{mcp-workflow} % e.g., MCP architecture diagram
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{adoption-timeline} % e.g., OpenAI/DeepMind adoption graphic
    \end{columns}
\end{frame}
